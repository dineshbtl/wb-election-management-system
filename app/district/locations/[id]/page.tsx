...
//   const [surveyBoothId, setSurveyBoothId] = useState<string | null>(null);
...
//             <p>
//               {assembly?.Assembly_Name || "—"}-({assembly.Assembly_No})
//             </p>
//           </div>
//           <div>
...
//             <Button
//               size="sm"
//               onClick={() => setSurveyBoothId(location.documentId)}
//             >
//               Raise Survey
//             </Button>
//           )}
...
//       <SurveyModal
//         open={!!surveyBoothId}
//         boothDocumentId={surveyBoothId!}
//         onClose={() => setSurveyBoothId(null)}
//         onSuccess={() => {
//           fetchSurveys();
//           setSurveyBoothId(null);
//         }}
//       />
