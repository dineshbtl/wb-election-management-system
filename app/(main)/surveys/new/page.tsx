...
//   jio_signal: number;
//   sim_speeds: { provider: string; download_speed: number; upload_speed: number; latency: number }[];
...
//             className="inline-flex items-center px-3 py-2 bg-gradient-to-r from-amber-400 to-yellow-500 text-white text-sm font-medium rounded-lg cursor-pointer hover:from-amber-500 hover:to-yellow-600 transition-colors"
//           >
...
//     jio_signal: 0,
//     sim_speeds: [
//       { provider: "airtel", download_speed: 0, upload_speed: 0, latency: 0 },
//       { provider: "jio", download_speed: 0, upload_speed: 0, latency: 0 },
//     ],
...
//         setExistingSurvey(res.data.data[0]);
//         toast({
//           variant: "destructive",
//           title: "Survey Already Exists",
//           description: `A survey was already submitted for this booth on ${new Date(res.data.data[0].survey_date).toLocaleDateString()}.`,
//         });
//       } else {
//         setExistingSurvey(null);
//       }
...
//                   description: "Using network (IP) location. Enable device location for better accuracy.",
//                 });
//               } else {
//                 setGpsStatus("error");
//                 setIsRefreshingGPS(false);
...
//                 description: "Check connection and try again, or allow device location.",
//               });
//             });
//         },
...
//               variant: "destructive",
//               title: "Unsupported",
//               description: "GPS not supported. Use a supported browser or device.",
//             });
//           }
//         })
//         .catch(() => {
...
//                     {selectedBooth && (() => {
//                       const booth = booths.find((b) => b.documentId === selectedBooth);
//                       const districtName = districts.find((d) => d.id === selectedDistrict)?.name;
//                       const assemblyName = assemblies.find((a) => a.id === selectedAssembly)?.name;
//                       return (
...
//                             {booth?.PS_No != null && (
//                               <span className="text-gray-600 font-normal"> (PS No: {booth.PS_No})</span>
//                             )}
//                           </p>
//                         </div>
//                       );
...
//                           <div className="flex items-center justify-between rounded-xl border p-4 bg-yellow-50 border-yellow-200">
//                             <Label className="text-sm font-medium text-gray-700">
//                               Socket Working
//                             </Label>
//                             <Switch
...
import CreateSurveyPage from "@/components/survey/Newsurvey";
