...
//                     {location.booth_coordinator.profile?.Full_Name || location.booth_coordinator.username || "—"}
//                   </p>
//                 </div>
//                 <div>
...
//                   <p>{location.booth_coordinator.profile?.Phone_Number || "—"}</p>
//                 </div>
//                 <div>
//                   <p className="font-semibold text-gray-700">Father's Name:</p>
//                   <p>{location.booth_coordinator.profile?.Father_Name || "—"}</p>
//                 </div>
//                 {/* <div>
