...
export function Distrcitheader({
  title,
  subtitle,
  showSearch = true,
  showGPS = true,
  ...
  const notificationList = (
    <div className="w-96 sm:w-72 bg-gray-50 rounded-xl shadow-lg overflow-hidden">
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-6">
          ...
          {/* {showGPS && (
            <div className=" hidden md-block lg:flex items-center space-x-2 px-3 py-2 bg-white/50 backdrop-blur-sm rounded-full border border-gray-200">
              {gpsStatus === "connected" ? (
