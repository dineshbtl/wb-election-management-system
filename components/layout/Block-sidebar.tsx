...
const navigation = [
  ...
  { name: "Surveys", href: "/block/surveys", icon: FileText },
  // { name: "Projects", href: "/projects", icon: FileText },
  // { name: "Cameras", href: "/cameras", icon: Camera },
  { name: "Booths", href: "/block/locations", icon: MapPin },
  {
...
export function Blocksidebar({ isOpen = false, onClose }: ModernSidebarProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "bg-white/30 backdrop-blur-sm border-r border-gray-300/70 flex flex-col h-screen overflow-y-auto custom-scrollbar md:w-auto",
